...
- Zome call argument update: see [#1203](https://github.com/holochain/holochain-rust/pull/1203) and [#1271](https://github.com/holochain/holochain-rust/pull/1271)

### Deprecated

- `params` Zome call argument deprecated in favor of `args`.
