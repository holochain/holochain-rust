...
Holochain welcomes many sorts of contributions like bug-report & fixes, code contributes, documentation, tests, feedback and more.
...
* [chat server](https://chat.holochain.org)
* [Gitter](https://gitter.im/metacurrency/holochain)
...
Run the formatter with one of the following cli commands:
...
1. Add the dependency to `docker/Dockerfile.ubuntu`
...
Submit your CI-changes as a separate Pull Request first.
Once it is merged, the CI environment should be up-to-date for your code change Pull Request.

Alternatively: speak to an admin who can force merge your full changes after testing locally.
