...
wasm_build: ensure_wasm_target
	...
	cd container_api/wasm-test/round_trip && $(CARGO) build --release --target wasm32-unknown-unknown
	cd container_api/wasm-test/commit && $(CARGO) build --release --target wasm32-unknown-unknown
