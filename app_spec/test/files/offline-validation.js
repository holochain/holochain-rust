...
module.exports = scenario => {
      ...
      scenario('Can retrieve own header entries using get_entry', async (s, t) => {
        const { alice } = await s.players({alice: one})
        await alice.spawn()
        ...
        t.equal(chain_header_hashes.length, 3) // dna, agentId and cap grant
