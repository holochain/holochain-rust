...
scenario2.runTape('update_post', async (t, { alice, bob }) => {
  ...
  //get history entry v4
   ...
   t.deepEqual(entryHistoryV4.Ok.items[0].entry,{ content: "Hello Holo world 123", date_created: "now" });
