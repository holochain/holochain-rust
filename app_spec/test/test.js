...
scenario1.runTape('show_env', async (t, { alice }) => {
  ...
  t.equal(result.Ok.agent_id, '{"nick":"alice","pub_sign_key":"' + alice.agentId + '"}')
    t.deepEqual(result.Ok.cap_request, { cap_token: 'QmNcz2YwddnafZLzhcoXuTUU4Gr3jpAEH9Q8mfEjvMmME4', provenance: [ alice.agentId, '+78GKy9y3laBbCNK1ajrj2rYVV3lBOxzGAZuuLDqXL2MLJUbMaB4lv7ut/UPWSoEeHx7OuXrTFXfu+PihtMMBQ==' ] }
);
