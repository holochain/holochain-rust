...
module.exports = scenario => {
  ...
  scenario('An agent that does not pass validate_agent will not have a visible entry in the DHT', async (s, t) => {
    ...
    let get_self_result = await valid_agent.call('app', "simple", "get_entry", {address: valid_agent.info('app').agentAddress})
    let get_other_result = await valid_agent.call('app', "simple", "get_entry", {address: reject_agent.info('app').agentAddress})
