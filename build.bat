...
cd core/wasm-test/round_trip && cargo +nightly-2018-10-12 build --release --target wasm32-unknown-unknown && cd ../../../
cd core/wasm-test/commit && cargo +nightly-2018-10-12 build --release --target wasm32-unknown-unknown && cd ../../../
