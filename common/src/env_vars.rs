...
//! for details.
//! - **HC_N3H_MODE** *string* **REAL** OR **HACK** OR **MOCK** Sets the mode N3H operates in. Defaults to REAL which is what you should use unless your testing (MOCK) or you know what you're doing (HACK - might be removed soon).
