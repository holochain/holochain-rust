let
 release-commit = "b31770d4d9ba5e7da45caa0b858c9109088dc9a8";
 current = "0.0.37-alpha6";
 previous = "0.0.37-alpha5";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.39";
 holonix-sha256 = "1c8jk9cmpayjy7bndymx5c7wshwgd7a2xqda4lvp2y7ds72i8jhz";
in
rec {
