let
 release-commit = "6a6994e6110301bde4197b69999fa8d2c9fd413e";
 current = "0.0.44-alpha1";
 previous = "0.0.43-alpha3";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.66";
 holonix-sha256 = "1al3in1p5g6prll6fbbhrz6aydj8nm9z0di88hjwvinkj872v3vh";
in
rec {
