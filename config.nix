let
 release-commit = "3bca5c4dd7be3fbe8f9bb3649586f35d3400237e";
 current = "0.0.52-alpha1";
 previous = "0.0.51-alpha4";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.83";
 holonix-sha256 = "1xb96i8mwb2yfnmpwy2sp4s2ybbh3zj6hrpxbqsccqwp0gwvj9z5";
in
rec {
