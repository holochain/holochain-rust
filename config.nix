let
 release-commit = "40fc74992d108fe0b810e17d5ebf8e02f3901ce0";
 current = "0.0.51-alpha1";
 previous = "0.0.50-alpha4";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.81";
 holonix-sha256 = "15c5265ipl8n85llsg6rlwc0pz70bbi6ncd1sj46f4ill50dkkj0";
in
rec {
