let
 release-commit = "6cca057589e39c06d5b0af0b1b516782e4e4b59b";
 current = "0.0.42-alpha1";
 previous = "0.0.41-alpha4";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.54";
 holonix-sha256 = "1z2pp6ba73f6n8svs0aql98d63v3prybw09rjf856xzzc34lhjga";
in
rec {
