let
  release-commit = "7d527a6c49f09ba44031b879e3ae534c02296adf";
 current = "0.0.45-alpha1";
 previous = "0.0.44-alpha3";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.71";
 holonix-sha256 = "1jav1sr3kh1f204rarcis8cm59fwbapg8wqnp9dpyz7c5kvhkwnx";
in
rec {
