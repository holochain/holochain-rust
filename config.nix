let
 release-commit = "111ee71f9b9814d20909c26336b0ebaf6be62f33";
 current = "0.0.42-alpha4";
 previous = "0.0.42-alpha3";
 ...
 tag = "v${current}";
 holonix-version = "v0.0.60";
 holonix-sha256 = "19n762db5cpl5hwqgh61d99ck71k6i53k46l3njh7algcs3mbnrs";
in
rec {
