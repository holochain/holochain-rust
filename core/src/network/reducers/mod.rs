...
use crate::{
    ...
    network::{
        ...
        reducers::{
            ...
            get_links_count::{reduce_get_links_count, reduce_get_links_count_by_tag,reduce_get_links_timeout_by_tag},
            ...
            handle_get_links_result_count::{
                reduce_handle_get_links_count, reduce_handle_get_links_count_by_tag,
            },
            ...
            respond_get_links_count::{reduce_respond_get_links_count,reduce_respond_get_links_count_by_tag},
...
fn resolve_reducer(action_wrapper: &ActionWrapper) -> Option<NetworkReduceFn> {
    match action_wrapper.action() {
        ...
        Action::GetLinksTimeoutByTag(_)=>Some(reduce_get_links_timeout_by_tag),
        ...
        Action::HandleGetLinksResultCountByTag(_) => Some(reduce_handle_get_links_count_by_tag),
        ...
        Action::RespondGetLinksCountByTag(_) =>Some(reduce_respond_get_links_count_by_tag),
