...
pub mod tests {
    ...
    use holochain_core_types::{
        ...
        dna::{capabilities::{Capability, CapabilityType}, entry_types::EntryTypeDef, Dna},
        entry::Entry,
        json::RawString,
    };
    use std::sync::Arc;
    ...
    pub fn test_dna() -> Dna {
        ...
        let mut dna = create_test_dna_with_cap("test_zome", "test_cap", &Capability::new(CapabilityType::Public), &wasm);
