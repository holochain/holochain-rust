...
pub mod tests {
    ...
    fn example_eav_round_trip() {
        ...
        EAVTestSuite::test_round_trip_test_runner(eav_storage, entity, attribute, value)
    }

    impl EAVTestSuite {
        fn test_round_trip_test_runner(
        ...
        fn test_one_to_many<A, S>(mut eav_storage: S)
        where
        ...
        fn test_many_to_one<A, S>(mut eav_storage: S)
        where
            A: AddressableContent + Clone,
            S: EntityAttributeValueStorage,
        {
