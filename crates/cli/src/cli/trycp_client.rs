...
pub fn trycp_client(url_string: String, message_string: String) -> Result<(), String> {
...
impl Job {
    ...
    pub fn send_wire(&mut self, message: String) {
        ...
        self.connection.write(message.into()).unwrap();
    }
}
