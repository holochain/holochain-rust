...
impl From<PendingValidationStruct> for EntryAspect{
    fn from(pending: PendingValidationStruct) -> EntryAspect {
        match pending.workflow {
            ValidatingWorkflow::HoldEntry => EntryAspect::Content(pending.entry_with_header.entry.clone(), pending.entry_with_header.header.clone()),
            ValidatingWorkflow::HoldLink => {
            ...
            ValidatingWorkflow::UpdateEntry => EntryAspect::Update(pending.entry_with_header.entry.clone(), pending.entry_with_header.header.clone()),
            ValidatingWorkflow::RemoveEntry => EntryAspect::Deletion(pending.entry_with_header.header.clone()),
        }
    }
}
