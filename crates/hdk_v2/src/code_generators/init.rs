    ...
    pub fn init(&self) -> TokenStream {
        ...
        quote! {
            ...
            pub extern "C" fn init(host_allocation_ptr: hdk::holochain_core_types::error::AllocationPtr) -> hdk::holochain_core_types::error::AllocationPtr {
                let maybe_allocation = hdk::holochain_wasm_engine::memory::allocation::WasmAllocation::try_from_ribosome_encoding(host_allocation_ptr);
                ...
                if init.is_err() {
                    return hdk::holochain_wasm_engine::memory::ribosome::return_code_for_allocation_result(
                        init
                    ).into();
                }
                ...
                match execute() {
                    ...
                    Err(e) => hdk::holochain_wasm_engine::memory::ribosome::return_code_for_allocation_result(
                        hdk::global_fns::write_json(
                            hdk::holochain_wasm_engine::holochain_json_api::json::RawString::from(e)
                        )
                    ).into(),
                }
            }
