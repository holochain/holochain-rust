...
pub struct SourceChain {
    headers: Vec<Header>, // an ordered sequence of headers
    entries: std::collections::HashMap<Entry>, // a hash map of entries
    agent: Agent // a reference back to the agent this chain is for
}
