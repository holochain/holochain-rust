...
///
pub(crate) fn decode_pub_key_into_secbuf(pub_key_b32: &str, codec: &HcidEncoding) -> HcResult<SecBuf> {
...
pub fn verify_sign(pub_sign_key_b32: Base32, data: &mut SecBuf, signature: &mut SecBuf) -> HcResult<bool> {
