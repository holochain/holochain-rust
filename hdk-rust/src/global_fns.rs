...
pub fn store_and_return_output<J: Into<JsonString>>(jsonable: J) -> u32 {
    unsafe { return store_as_json_into_encoded_allocation(&mut G_MEM_STACK.unwrap(), jsonable) as u32 }
}
