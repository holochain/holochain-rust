...
>(
    base: &Address,
    tag: S
) -> ZomeApiResult<Vec<ZomeApiResult<R>>> {
...
pub fn get_as_type<
	R: TryFrom<AppEntryValue>
> (address: Address) -> ZomeApiResult<R> {
...
pub fn link_entries_bidir<S: Into<String>>(a: &Address, b: &Address, tag_a_b: S, tag_b_a: S) -> ZomeApiResult<()> {
