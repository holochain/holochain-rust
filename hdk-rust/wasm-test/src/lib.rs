            ...
            links: [
                to!(
                    ...
                    validation: |validation_data: hdk::LinkValidationData | {
                        ...
                        {
                            LinkValidationData::LinkAdd{link,validation_package:_,lifecycle:_} => link.clone(),
                            LinkValidationData::LinkRemove{link,validation_package:_,lifecycle:_} => link.clone()
                        };
