...
const DOWNLOAD_BASE_URL: &'static str = "https://codeload.github.com/zeromq/libzmq/legacy.tar.gz/";
const VERSION: &'static str = "eff190d5031d313451505f323d3dd1c38ab9c25c";

// zeromq-<version>.tar.gz
const SHA256: &'static str = "963a38a4d5e9a75f37366f3f005af214b2a861dc64faa42189faa4a0a5d49a1e";
...
fn get_zmq() {
    ...
    let url = format!("{}{}", DOWNLOAD_BASE_URL, VERSION);
    ...
    if install_dir.contains(" ") {
        let fallback_path = "/tmp/".to_string() + &VERSION + "/" + &target;
        ...
        println!(
            "cargo:warning=The path to the usual build directory contains spaces and hence \
             can't be used to build zeromq.  Falling back to use {}.  If running `cargo \
    ...
    source_dir.push_str(&format!("/{}", VERSION));
    ...
    println!("cargo:rustc-link-lib=static=zeromq");
