let
  ...
  hc-tarpaulin = nixpkgs.writeShellScriptBin "hc-tarpaulin" "cargo -Z rename-depencency tarpaulin --ignore-tests --timeout 600 --all --out Xml --skip-clean -v -e holochain_core_api_c_binding -e hdk -e hc -e holochain_core_types_derive";
