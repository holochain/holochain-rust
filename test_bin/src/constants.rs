...
lazy_static! {
    ...
    pub static ref META_CRUD_CONTENT: Address = HashString::from("LIVE");
    pub static ref META_LINK_CONTENT_1: Address = HashString::from("hello-meta");
    pub static ref META_LINK_CONTENT_2: Address = HashString::from("hello-2-meta");
    pub static ref META_LINK_CONTENT_3: Address = HashString::from("hello-3-meta");
